...
def main(host: str, port: int):
    skill = AgentSkill(
        id="public-speaking-coach-agent",
        name="public-speaking-coach-agent",
        description="An interactive AI coach that guides users to master public speaking through weekly models, script practice, and iterative feedback.",
        tags=["public-speaking", "coaching", "learning", "agent"],
        examples=["Show me this week's public speaking model", "Here is my script, please give me feedback"],
    )
